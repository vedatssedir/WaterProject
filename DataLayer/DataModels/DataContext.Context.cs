...
namespace DataLayer.DataModels
{
    ...
    public partial class TaskestiDataContext : DbContext
    {
        public TaskestiDataContext()
            : base("name=TaskestiDataContext")
        {
        }
        ...
        public virtual DbSet<EPostalar> EPostalar { get; set; }
