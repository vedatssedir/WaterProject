!function (t) {
    "use strict"; function s(e) {
        1 === t("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (t("#dark-mode-switch").prop("checked", !1),
            ...
            sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 === t("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ?
                (t("#light-mode-switch").prop("checked", !1),
                    ...
                    sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 === t("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e &&
                (t("#light-mode-switch").prop("checked", !1),
