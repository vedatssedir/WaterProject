$(function () {
    ...
    $("#showtoast").click(function () {
        ...
        toastr.options =
        {
            ...
            preventDuplicates: $("#preventDuplicates").prop("checked"), onclick: null
        },
            ...
            k && (t = (t = a) || "Clear itself?", a = t += '<br /><br /><button type="button" class="btn-primary btn clear">Yes</button>',
                toastr.options.tapToDismiss = !1),
            a || (++g === (o = ["My name is Inigo Montoya. You killed my father. Prepare to die!",
                ...
                a = o[g]), $("#toastrOptions").text('Command: toastr["' + e + '"]("' + a + (n ? '", "' + n : "") + '")\n\ntoastr.options = ' + JSON.stringify(toastr.options, null, 2)); var v = toastr[e](a, n);
        void 0 !== (m = v) && (v.find("#okBtn").length && v.delegate("#okBtn", "click", function () {
            ...
            }), v.find(".clear").length && v.delegate(".clear", "click", function () { toastr.clear(v, { force: !0 }) }))
    }),
    $("#clearlasttoast").click(function () { toastr.clear(m); }),
